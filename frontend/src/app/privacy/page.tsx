    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-700 via-fuchsia-800 to-purple-900 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/terms" className="text-pink-300 hover:text-pink-100 text-sm transition">
            Terms & Guidelines →
          </Link>
        </div>

        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-pink-50">Privacy Policy</h1>
        ...
        <div className="bg-pink-50 rounded-3xl shadow-2xl shadow-purple-900/30 overflow-hidden">
          ...
          <div className="px-8 py-8 divide-y divide-pink-100">
            {sections.map((s, i) => (
          ...
          <div className="bg-pink-100/50 border-t border-pink-100 px-8 py-4 flex items-center justify-between">
            <p className="text-xs text-purple-400">Questions? support@chatster.app</p>
