      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-2xl shadow-purple-900/30">
          <div className="bg-gradient-to-r from-pink-600 to-purple-700 px-8 py-6">
            ...
            <p className="text-pink-200 text-sm mt-1">Join Chatster today — it's free</p>
          </div>
          ...
          <div className="px-8 py-7 space-y-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className={`w-full border rounded-xl px-4 py-3 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 transition ${
                  mismatch
                    ? "border-red-300 bg-red-50/40 focus:ring-red-300"
                    : "border-pink-100 bg-pink-50/40 focus:ring-pink-400 focus:border-pink-400"
                }`}
              />
              {mismatch && (
            ...
            <button
              ...
              disabled={mismatch}
              className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-semibold py-3 rounded-xl shadow-md shadow-pink-200/50 transition mt-2 disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Create Account
            </button>
