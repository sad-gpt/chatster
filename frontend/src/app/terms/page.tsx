    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-700 via-fuchsia-800 to-purple-900 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/privacy" className="text-pink-300 hover:text-white text-sm transition">
            Privacy Policy →
          </Link>
        </div>
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white">Terms & Community Guidelines</h1>
        ...
        <div className="bg-white rounded-3xl shadow-2xl shadow-purple-900/30 overflow-hidden">
          ...
          <div className="px-8 py-8 divide-y divide-gray-100 space-y-0">
            {sections.map((s, i) => (
          ...
          <div className="bg-gray-50 border-t border-gray-100 px-8 py-4 flex items-center justify-between">
            <p className="text-xs text-gray-400">Questions? Contact us at support@chatster.app</p>
